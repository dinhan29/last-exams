...
<head>
  ...
  <!-- <link rel="stylesheet" href="/user/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css"> -->
  <!-- Tempusdominus Bootstrap 4 -->
  <!-- <link rel="stylesheet" href="/user/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css"> -->
  <!-- Select2 -->
  <!-- <link rel="stylesheet" href="/user/plugins/select2/css/select2.min.css"> -->
  <!-- <link rel="stylesheet" href="/user/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css"> -->
  <!-- Bootstrap4 Duallistbox -->
  <!-- <link rel="stylesheet" href="/user/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css"> -->
  <!-- BS Stepper -->
  <!-- <link rel="stylesheet" href="/user/plugins/bs-stepper/css/bs-stepper.min.css"> -->
  <!-- dropzonejs -->
  <!-- <link rel="stylesheet" href="/user/plugins/dropzone/min/dropzone.min.css"> -->
  <!-- Theme style -->
  <!-- <link rel="stylesheet" href="/user/dist/css/adminlte.min.css"> -->

  <!-- myCSS -->
  <link rel="stylesheet" href="/user/dist/css/mystyle.css">
  @yield('css')
</head>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="/user/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Test Exams</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/listexam" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/myresult" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/category/12" class="nav-link">
                  <i class="nav-icon far fa-plus-square"></i>
                  <p>Maths</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/category/16" class="nav-link">
                  <i class="nav-icon fa fa-wrench"></i>
                  <p>Physics</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/category/17" class="nav-link">
                  <i class="nav-icon fa fa-thermometer-full"></i>
                  <p>Chemistry</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/category/19" class="nav-link">
                  <i class="nav-icon fa fa-leaf"></i>
                  <p>Biology</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/category/18" class="nav-link">
                  <i class="nav-icon fa fa-laptop"></i>
                  <p style="font-size: 15px;">Information Technology</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/category/13" class="nav-link">
                  <i class="nav-icon fa fa-book"></i>
                  <p>Literature</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/category/15" class="nav-link">
...
@yield('js')
<!-- My JS -->
<script src="/user/dist/js/myjs.js"></script>
</body>
</html>
